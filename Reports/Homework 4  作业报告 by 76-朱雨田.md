...
| ------------------------- | ------------------------- | ------------------------- |
| ![](assets\balls1.png)  | ![](assets\balls2.png)  | ![](assets\balls3.png)  |
| ![](assets\ballss1.png) | ![](assets\ballss2.png) | ![](assets\ballss3.png) |
| ![](assets\ballsc1.png) | ![](assets\ballsc2.png) | ![](assets\ballsc3.png) |

​	David 模型的效果如图所示。可以注意到因为颈部尺寸过小而引起的扭曲，使得头部在纹理图中被分配的面积过小。

| Uniform                   | Cotangent                 | Floater                   |
| ------------------------- | ------------------------- | ------------------------- |
| ![](assets\david1.png)  | ![](assets\david2.png)  | ![](assets\david3.png)  |
| ![](assets\davids1.png) | ![](assets\davids2.png) | ![](assets\davids3.png) |
| ![](assets\davidc1.png) | ![](assets\davidc2.png) | ![](assets\davidc3.png) |
