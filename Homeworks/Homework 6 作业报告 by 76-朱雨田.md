...
因为作业框架稳定下来较晚，这个周末的杂事又比较多，所以现在提交的版本里暂时还只做了作业的必要部分，报告也写的比较简略。如果有空，我会把两项 Optional 也做完。

报告中图片如未特别标注，则都经过了 Gamma 校正以得到更好的视觉效果。

以下是展示效果：

![1713021161779](C:\Users\Admin\Documents\GitHub\USTC_CG_24\Homeworks\assets\1713021161779.png)
...
![1713022610492](C:\Users\Admin\Documents\GitHub\USTC_CG_24\Homeworks\assets\1713022610492.png)
...
![1713023073190](C:\Users\Admin\Documents\GitHub\USTC_CG_24\Homeworks\assets\1713023073190.png)
...
![1713023745381](C:\Users\Admin\Documents\GitHub\USTC_CG_24\Homeworks\assets\1713023745381.png)

![1713023759072](C:\Users\Admin\Documents\GitHub\USTC_CG_24\Homeworks\assets\1713023759072.png)
...
| 校正前                                                       | 校正后                                                       |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![1713024051417](C:\Users\Admin\Documents\GitHub\USTC_CG_24\Homeworks\assets\1713024051417.png) | ![1713024109857](C:\Users\Admin\Documents\GitHub\USTC_CG_24\Homeworks\assets\1713024109857.png) |
...
![1713024711204](C:\Users\Admin\Documents\GitHub\USTC_CG_24\Homeworks\assets\1713024711204.png)

这是计算阴影值的代码，也做了教程中的 bias 校正（但做校正前我并没有看到很明显的摩尔纹，有点奇怪）。这里将阴影的颜色值全部设置为了 $0$，非阴影全部设置为了 $1$，这会导致一些锯齿的问题。
...
![1713025050591](C:\Users\Admin\Documents\GitHub\USTC_CG_24\Homeworks\assets\1713025050591.png)
...
框架的一些 bug 耽误了不少时间。不过助教的反馈很积极，bug 的修改都很及时。如果以后能做充足的测试后再发布作业就好了！这样也许我就能在规划的时间内完成 Optional 了。

现在的报告里还没有完成两个 Optional，我会试着完成。如果报告没有赶上更新，那我就是被各种各样的事击败了（笑）不过这些在作业截止后也会试着去做的。